...
export const deliverables = [
  {
    tierHE: "האפיון האסטרטגי",
    tier: "The Strategic Blueprint",
    price: "₪3,000",
    timeline: "Diagnosis & Roadmap",
    note: "₪1,000 credit toward the full project if you proceed within 7 days",
    noteHE: "זיכוי ₪1,000 לפרויקט אם ממשיכים לשלב 2 תוך 7 ימים",
    featured: false,
    items: [
      "Deep-dive operational workflow mapping",
      "Identification of operational black holes",
      "Technical and human bottleneck diagnosis",
      "Comprehensive Strategic Blueprint — in 24 hours",
      "Custom Monday.com architecture plan",
      "Execution roadmap, KPIs, and projected ROI",
    ],
    itemsHE: [
      "מיפוי תהליכי עבודה תפעוליים בעומק",
      "זיהוי חורים שחורים תפעוליים",
      "אבחון צווארי בקבוק טכניים ואנושיים",
      "Blueprint אסטרטגי מקיף — תוך 24 שעות",
      "תכנון ארכיטקטורת Monday.com מותאמת",
      "רודמאפ ביצוע, KPI ו-ROI צפוי",
    ],
  },
  {
    tierHE: "הבניה המבצרית",
    tier: "The Fortress Build",
    price: "₪20,000",
    timeline: "One-time",
    featured: true,
    items: [
      "Everything in The Strategic Blueprint",
      "Full Monday.com infrastructure build",
      "Advanced Make.com automations",
      "Empathetic high-adoption team training",
      "100% data transparency across the operation",
      "A living system your team actually loves to use",
    ],
    itemsHE: [
      "כל מה שבאפיון האסטרטגי",
      "הקמת תשתית Monday.com מלאה",
      "אוטומציות Make.com מתקדמות",
      "הדרכת צוות אמפתית לאימוץ גבוה",
      "שקיפות נתונים 100% בכל התפעול",
      "מערכת חיה שהצוות שלך אוהב להשתמש בה",
    ],
  },
  {
    tierHE: "שקט תפעולי",
    tier: "Operational Peace of Mind",
    price: "₪2,500/month",
    timeline: "Ongoing",
    featured: false,
    items: [
      "Everything in The Fortress Build",
      "Ongoing system optimization",
      "Technical oversight and strategic support",
      "System evolves as your business scales",
      "Priority support and rapid response",
      "Quarterly strategic review sessions",
    ],
    itemsHE: [
      "כל מה שבבניה המבצרית",
      "אופטימיזציה שוטפת של המערכת",
      "פיקוח טכני ותמיכה אסטרטגית",
      "המערכת מתפתחת עם הצמיחה שלך",
      "תמיכה עדיפות ומענה מהיר",
      "סשני סקירה אסטרטגית רבעוניים",
    ],
  },
];
