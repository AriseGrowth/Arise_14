        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-14" style={{ borderBottom: "1px solid var(--neutral-border)" }}>
          ...
          <div id="contact-info">
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:david@arisegrowth.com" className="text-[13.5px] font-[300] transition-colors duration-200" style={{ color: "var(--neutral-faint)" }} onMouseEnter={e => (e.currentTarget.style.color = "var(--accent)")} onMouseLeave={e => (e.currentTarget.style.color = "var(--neutral-faint)")}>david@arisegrowth.com</a>
